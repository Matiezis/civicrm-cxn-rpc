...
class AesHelper {
  ...
  public static function createSecret() {
    return base64_encode(\phpseclib3\Crypt\Random::string(Constants::AES_BYTES));
  }
  ...
  public static function encryptThenSign($secret, $plaintext) {
    $iv = \phpseclib3\Crypt\Random::string(Constants::AES_BYTES);

    $keys = AesHelper::deriveAesKeys($secret);

    $cipher = new \phpseclib3\Crypt\AES(\phpseclib3\Crypt\AES::MODE_CBC);
